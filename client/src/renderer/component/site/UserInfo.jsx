...
function getMenu ({ exit, personal }) {
  return (
    <Menu>
      <Menu.Item key="profile" onClick={personal} ><ProfileOutlined />个人中心</Menu.Item>
      <Menu.Item key="version"><BarsOutlined />版本:0.1.0</Menu.Item>
      <Menu.Item key="quit" onClick={exit}><LogoutOutlined />退出</Menu.Item>
    </Menu>
  )
}
